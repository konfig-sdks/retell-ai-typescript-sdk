...
export interface BaseAgent {
     ...
     * @memberof BaseAgent
     */
    'ambient_sound'?: BaseAgentAmbientSoundEnum;
    /**
     ...
     * @memberof BaseAgent
     */
    'language'?: BaseAgentLanguageEnum;
    /**
...
type BaseAgentAmbientSoundEnum = 'coffee-shop' | 'convention-hall' | 'summer-outdoor' | 'mountain-outdoor' | 'null'
type BaseAgentLanguageEnum = 'en-US' | 'en-IN' | 'en-GB' | 'de-DE' | 'es-ES' | 'es-419' | 'hi-IN' | 'ja-JP' | 'pt-PT' | 'pt-BR'
